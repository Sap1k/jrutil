...
let conservativeRoutedV4 = {
    ...
    policyId="conservative-routed-v4"
    consolidation={
        maximumDiameterMetres=25.0
    ...
    alternativeCorridors={ absoluteTieMetres=25.0; relativeTieFraction=0.05; maximumVariants=3 }
    modality={
